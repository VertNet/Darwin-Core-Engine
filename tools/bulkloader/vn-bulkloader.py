...
class AppEngine(object):
    """This class wraps an HttpRpcServer. It is used so send secure HTTP requests
    to appengine.google.com for quota data using the supplied user credentials, an
    application id, and an application version.
    """
